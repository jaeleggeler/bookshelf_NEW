...
public class BuchLoeschenGUI extends JFrame{


    //Attribute
    JLabel lbl_ueberschrift, lbl_titel;
    JTextField txt_titel;
    JButton btn_loeschen, btn_abbrechen; 

    //Konstruktor
    public BuchLoeschenGUI(){
    ...
    private void initComponents(){
        ...
        //Überschrift
        lbl_ueberschrift = new JLabel("Buch löschen");
        ...
        btn_loeschen = new JButton("Buch ändern");
